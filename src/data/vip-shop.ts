...
export const vipShopContent: Record<Locale, VipShopContent> = {
  ro: {
    metadata: {
      ...
      description:
        "Cere VIP Gold sau VIP Diamond pe FREE-ARENA, testează VIP cu /testvip și activează VIP TS prin /ts și TeamSpeak.",
    },
    hero: {
      ...
      ticket: "Intră pe Discord",
    },
    activation: {
      title: "Cum se activează VIP?",
      copy:
        "Shop-ul FREE-ARENA funcționează momentan ca funnel manual. Nu există plată online automată, iar activarea se face după confirmare.",
      forumCta: "Vezi cererile VIP",
      discordCta: "Discuta cu staff",
      customTitle: "VIP Custom / Contact",
      customCopy:
        "Ai nevoie de acces garantat, activare specială sau clarificări pentru un server anume? Contactează-ne înainte de plată.",
      customCta: "Contact pentru VIP Custom",
      steps: [
        "Alegi pachetul potrivit.",
        "Ne contactezi pe forum sau Discord.",
        "Confirmăm plata și datele contului.",
        "Activăm VIP pe serverul ales.",
      ],
    },
    trial: {
      eyebrow: "Test VIP și VIP TS",
      title: "Testează VIP gratuit",
      copy:
        "Înainte să alegi Gold sau Diamond, poți testa beneficiile VIP direct pe server. Scrie comanda în chat și vezi cum se simte accesul premium.",
      commandTitle: "Comanda pe server",
      command: "/testvip",
      cta: "Intră pe server și testează",
      items: [
        "Prima testare dureaza 60 de minute.",
        "După prima testare, mai ai 5 testări disponibile.",
        "Fiecare testare următoare durează 30 de minute.",
        "Testul este pentru jucători noi sau jucători care vor să vadă beneficiile înainte de activare.",
      ],
      note:
        "Testul VIP nu înseamnă imunitate la reguli și poate fi limitat dacă serverul sau modul de joc impune restricții.",
      vipTsTitle: "VIP TS",
      vipTsCopy:
        "VIP TS este un sistem automat de pe serverul CS care îți oferă VIP gratuit cât timp ești conectat pe TeamSpeak. Intră pe cs.free-arena.ro, scrie /ts, primește codul și trimite-l botului VIP Verify pe TeamSpeak.",
      vipTsCta: "Intră pe server și scrie /ts",
      vipTsBenefits: [
        "Activează tagul [VIPTS] în joc pentru jucătorii fără VIP premium.",
        "Comenzi disponibile pe server: /ts, /tsvip și /tslink.",
        "Codul de verificare expiră în 5 minute și se trimite botului VIP Verify pe TeamSpeak.",
        "VIP TS rămâne activ cât timp ești online pe TeamSpeak.",
        "Când ieși de pe TeamSpeak, VIP TS se dezactivează automat.",
      ],
    },
    cta: {
      title: "Activare VIP manuală",
      gold: "Cere Gold",
    ...
    importantNotes: {
      ...
      items: [
        "VIP nu înseamnă imunitate la reguli.",
        "VIP nu permite injurii, abuz sau comportament toxic.",
        "Unele beneficii pot fi limitate pe hărți speciale.",
        "AWP poate fi blocat pe anumite hărți.",
        "Armele VIP se activează din runda 3.",
        "Activarea se face după confirmarea plății.",
      ],
    },
    support: {
      title: "TeamSpeak și acces garantat",
      copy:
        "Pentru suport rapid, activare VIP sau acces garantat, folosește TeamSpeak-ul comunității sau trimite email direct cu detaliile contului tău.",
      teamSpeakTitle: "TeamSpeak FREE-ARENA",
      teamSpeakCopy:
        "Intră pe voice pentru suport, verificări rapide și discuții cu staff-ul atunci când ai nevoie de ajutor pentru VIP.",
      teamSpeakCta: "Deschide TeamSpeak",
      emailTitle: "Acces garantat",
      emailCopy:
        "Pentru acces garantat, trimite email cu numele tău din joc, serverul, pachetul dorit și dovada plății.",
      emailCta: "Trimite email",
      items: [
        "Adresa TeamSpeak: ts.free-arena.ro",
        `Email acces garantat: ${contactEmail}`,
        "Include numele folosit pe server și pachetul VIP dorit.",
        "Activarea se face după confirmarea plății.",
      ],
    },
    packages: {
      queen: {
        ...
        price: "Gratis",
        tone: "queen",
        purpose: "Grad cosmetic gratuit pentru comunitate, evidențiat special pentru fete și jucătoare active.",
        cta: "Cere Queen",
        benefits: [
          "QUEEN tag cosmetic",
          "Grad vizual special pentru prezență feminină în comunitate",
