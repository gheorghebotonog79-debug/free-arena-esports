...
export function ParticlesBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <div className="absolute inset-0 bg-arena-grid bg-[size:72px_72px] opacity-[0.055]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(255,42,31,0.22),transparent_34%),radial-gradient(circle_at_82%_10%,rgba(0,230,255,0.14),transparent_28%),linear-gradient(180deg,transparent,rgba(0,0,0,0.72))]" />
      <div className="absolute inset-x-0 bottom-0 h-1/2 bg-[radial-gradient(ellipse_at_bottom,rgba(255,42,31,0.24),transparent_58%)] blur-2xl" />
      {embers.map((ember) => (
        <span
          className="ember"
