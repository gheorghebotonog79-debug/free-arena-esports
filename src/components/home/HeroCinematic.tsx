...
export function HeroCinematic() {
  ...
  return (
    <section className="neon-hero neon-hero--wow relative isolate overflow-hidden border-b border-cyan-300/15 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
      <ParticlesBackground />
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-7rem)] w-full max-w-7xl items-center gap-12 pt-8 lg:grid-cols-[minmax(0,1fr)_24rem] lg:pt-0">
        <div className="mx-auto w-full min-w-0 max-w-6xl text-center lg:mx-0 lg:text-left">
          ...
          <h1
            className="neon-heading hero-wow-title glitch-text mt-8 max-w-full break-words font-display text-5xl font-black uppercase leading-[0.82] tracking-[0.02em] text-white sm:text-7xl md:text-8xl lg:text-[8.2rem] xl:text-[9.4rem]"
            data-text={t("title")}
          >
            {t("title")}
          </h1>
          <p className="mt-6 font-display text-2xl font-black uppercase tracking-[0.08em] text-white sm:text-4xl lg:text-6xl">
            <span className="hero-wow-subtitle bg-gradient-to-r from-cyan-200 via-white to-red-200 bg-clip-text text-transparent">
              {t("subtitle")}
            </span>
          </p>
          <p className="mx-auto mt-6 max-w-3xl text-base font-semibold leading-7 text-slate-300 sm:text-lg lg:mx-0">
            {t("copy")}
          </p>
